$(document).ready(function () {
    $('body').prepend($(
        ...
        + '  </li>'
        + '  <li class="nav-item">'
        + '  <a class="nav-link" href="/html/doctor/start_examination.html">Start examination</a>'
        + '  </li>'
		+ ' <li class="nav-item">'
        + '  <a class="nav-link" href="/html/doctor/create_appointment.html">Create appointment</a>'
        + '  </li>'
		+ '  <li class="nav-item">'
