...
public class PricePharmacyComparator implements Comparator<PharmacyDTO>{
	
	private Order order;
	
	public PricePharmacyComparator(Order order) {
		// TODO Auto-generated constructor stub
		this.order = order;
	}
	@Override
	public int compare(PharmacyDTO o1, PharmacyDTO o2) {
		Double diffAsc = o1.pharmacistPrice - o2.pharmacistPrice;
		if(diffAsc != 0) {
